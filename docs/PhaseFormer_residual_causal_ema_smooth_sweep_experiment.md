...
> 状态：**已完成并回填（2026-09-12）。** 判定为 **3/7 部分信号**（ETTh2-96、ETTm2-96、
> Electricity-336，方向全部为"平滑越强越差"），高于 boxcar 扫描的 2/7（无可检测效应），
> 但两轮合计 14 个 (setting, 算子) 组合中**无一出现"平滑显著改善"**；7 setting × 5 档 = 35 runs，
> seed 2021。结果见 §6，产物见 §8。
