        ...
        for component in COMPONENTS:
            ...
            for direction, origins in (("x_minus_a_better", picked_x), ("only_a_better", picked_only)):
                ...
                for rank, origin in enumerate(origins, 1):
                    ...
                    row = {"setting": f"{dataset}_h96_seed2021", "dataset": dataset, "component": component, "direction": direction, "rank": rank, "origin": origin, "channel": 0, "baseline_mae": metrics["baseline"], "x_minus_a_mae": metrics["x_minus_a"], "only_a_mae": metrics["only_a"], "only_minus_x_mae": float(difference[origin]), "route_curve_mad": float(route_gap[origin]), **features}
