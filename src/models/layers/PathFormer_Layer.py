...
import numpy as np
from .PathFormer_Embedding import *


class Transformer_Layer(nn.Module):
    def __init__(self, device=None, d_model=32, d_ff=64, num_nodes=1, patch_nums=8, patch_size=8, dynamic=False, factorized=True, layer_number=1, batch_norm=False):
