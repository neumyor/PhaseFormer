...
from .PathFormer_Layer import Transformer_Layer
from .PathFormer_Utils import SparseDispatcher, FourierLayer, series_decomp_multi, MLP


class AMS(nn.Module):
    def __init__(self, input_size, output_size, num_experts, device=None, num_nodes=1, d_model=32, d_ff=64, dynamic=False,
