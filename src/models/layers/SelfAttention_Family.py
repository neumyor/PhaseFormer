...
class AttentionLayer(nn.Module):
    def __init__(
        self, attention, d_model, n_heads, d_keys=None, d_values=None, downsample_div=1
    ):
        ...
        self.query_projection = nn.Linear(d_model, d_keys * n_heads // downsample_div)
        self.key_projection = nn.Linear(d_model, d_keys * n_heads // downsample_div)
        self.value_projection = nn.Linear(d_model, d_values * n_heads // downsample_div)
